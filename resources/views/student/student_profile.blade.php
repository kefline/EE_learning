                ...
                <div class="card-body text-center pb-3">
                    ...
                    <div class="achievements ">
                        ...
                        <div class="achievements-content flex-wrap">
                            <span><img src="/Assets/images/svg/cup.svg" alt=""></span>
                            <span><img src="/Assets/images/svg/puzzle.svg" alt=""></span>
                            <span><img src="/Assets/images/svg/planet.svg" alt=""></span>
                            <span><img src="/Assets/images/svg/skill.svg" alt=""></span>
                            <span><img src="/Assets/images/svg/readingtime.svg" alt=""></span>
                        </div>
                    </div>
                    ...
                    <div class="card profile-widget">
                        <div class="card-body">
                            <div class="widget-courses align-items-center d-flex justify-content-between style-1 flex-wrap">
                                <div class="d-flex">
                                    <img src="/Assets/images/svg/degree-certificate.svg" alt="">
                                    <div class="ms-4">
                                        <h4>100</h4>
                                        <span>Completed</span>
                                    </div>
                                </div>
                                <a href="courses.html"><i class="las la-angle-right text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-sm-6">
                    <div class="card profile-widget">
                        <div class="card-body">
                            <div class="widget-courses align-items-center d-flex justify-content-between style-1 flex-wrap">
                                <div class="d-flex">
                                    <img src="/Assets/images/svg/clock-1.svg" alt="">
                                    <div class="ms-4">
                                        <h4>100</h4>
                                        <span>Progress</span>
                                    </div>
                                </div>
                                <a href="courses.html"><i class="las la-angle-right text-secondary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="students1">
                                <div class="d-inline-block position-relative donut-chart-sale me-4">
                                    <span class="donut1"
                                        data-peity='{ "fill": ["rgba(76, 188, 154, 1)", "rgba(245, 245, 245, 1"],   "innerRadius": 38, "radius": 5}'>5/7</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="students1">
                                <div class="d-inline-block position-relative donut-chart-sale me-4">
                                    <span class="donut1"
                                        data-peity='{ "fill": ["rgba(254, 198, 79, 1)", "rgba(245, 245, 245, 1"],   "innerRadius": 38, "radius": 5}'>5/8</span>
                                ...
                                <li>
                                    <svg class="me-2" width="12" height="12" viewBox="0 0 12 12"
                                        ...
                                        <rect x="1.5" y="1.5" width="9" height="9" rx="4.5"
                                            fill="white" stroke="#FEC64F" stroke-width="3" />
                                    </svg>
                                    Last Month
                                </li>
                                <li>
                                    <svg class="me-2" width="12" height="12" viewBox="0 0 12 12"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="1.5" y="1.5" width="9" height="9" rx="4.5"
                                            fill="white" stroke="#4CBC9A" stroke-width="3" />
                                    </svg>
                                    Last Month
                                </li>
                            </ul>
...
<script src="/Assets/js/dashboard/my-profile.js"></script>
