                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="badge light badge-success"
                                                        style="margin-right: 10px;">Multiple Choice</span></td>
                                            ...
                                            <tr>
                                                <td><span class="badge light badge-info"
                                                        style="margin-right: 10px;">True/False</span></td>
                                                <td>Select true or false for each statement.</td>
                                                <td>
                                                    <button class="btn btn-primary mb-5"
                                                        onclick="startExam('trueFalse')">Start Exam</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><span class="badge light badge-warning"
                                                        style="margin-right: 10px;">Short Answer</span></td>
                                                <td>Provide a brief answer to the question.</td>
                                                <td>
                                                    <button class="btn btn-primary"
                                                        onclick="startExam('shortAnswer')">Start Exam</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
