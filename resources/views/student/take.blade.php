                ...
                <table class="table verticle-middle table-responsive-md">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span class="badge badge-rounded badge-success">Completed</span></td>
                            <td>85%</td>
                            <td class="text-end">
                                <div class="dropdown custom-dropdown mb-0">
                                    <div class="btn sharp btn-primary tp-btn" data-bs-toggle="dropdown">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24"><circle fill="#000000" cx="12" cy="5" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="12" cy="19" r="2"/></svg>
                                    </div>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="javascript:void();">View Results</a>
                                        <a class="dropdown-item text-danger" href="javascript:void();">Retake Exam</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>N/A</td>
                            <td class="text-end">
                                <a href="start_exam.html?exam_id=EX-002" class="btn btn-success">Start Exam</a>
                            </td>
                        </tr>
