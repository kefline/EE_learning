                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            <span>10 minutes ago</span>
                                            <h6 class="mb-0">John submitted Assignment 3 <strong
                                                    class="text-primary">Grade: A</strong>.</h6>
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            ...
                                            <h6 class="mb-0">Submit final draft for English paper <strong
                                                    class="text-primary">Due Tomorrow</strong>.</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge info"></div>
