...
<!-- Mirrored from getskills.dexignzone.com/xhtml/instructor-transactions.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Sep 2024 13:16:58 GMT -->
                                    ...
                                    <table class="table display mb-4 dataTablesCard order-table card-table text-black application">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button class="btn btn-secondary" onclick="viewDetails('Mathematics')">View</button></td>
                                            </tr>
                                            <tr>
                                                <td>Science</td>
                                                <td>85</td>
                                                ...
                                                <td>A</td>
                                                <td><span class="badge light badge-success">Passed</span></td>
                                                <td><button class="btn btn-secondary" onclick="viewDetails('Science')">View</button></td>
                                            </tr>
                                            <tr>
                                                <td>History</td>
                                                <td>75</td>
                                                ...
                                                <td>B</td>
                                                <td><span class="badge light badge-success">Passed</span></td>
                                                <td><button class="btn btn-secondary" onclick="viewDetails('History')">View</button></td>
                                            </tr>
                                            <tr>
                                                <td>English</td>
                                                <td>88</td>
                                                ...
                                                <td>A</td>
                                                <td><span class="badge light badge-success">Passed</span></td>
                                                <td><button class="btn btn-secondary" onclick="viewDetails('English')">View</button></td>
                                            </tr>
                                            <tr>
                                                <td>Geography</td>
                                                <td>80</td>
                                                ...
                                                <td>B+</td>
                                                <td><span class="badge light badge-success">Passed</span></td>
                                                <td><button class="btn btn-secondary" onclick="viewDetails('Geography')">View</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
function viewDetails(subject) {
    // Implement the logic to view details for the selected subject
    alert('Viewing details for: ' + subject);
    // You can redirect or open a modal with more information.
}
</script>
