            ...
            <div class="card-body">
                ...
                <form action="{{route('instructor_questions.store')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="questiontypedescription">Question Type Description</label>
                            <textarea name="description" id="description" cols="10" rows="2" class="form-control input-default">
