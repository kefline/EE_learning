							...
							<div class="col-xl-6 col-md-6 sign text-center">
								<div>
									<div class="text-center my-5">
										<a href="/index"><h6 class="fs-10">Online Examination System</h6></a>
									</div>
									<img src="/Assets/images/log.png" class="education-img"></img>
								</div>	
							</div>
							<div class="col-xl-6 col-md-6">
								<div class="sign-in-your">
									<h4 class="fs-20 font-w600 text-black">Sign in your account</h4>
									...
									<form method="POST" action="{{ route('login') }}">
										...
										<div class="mb-3">
											...
											<input type="password" name="password" id="password" class="form-control" value="" required autocomplete="current-password">
                                            <x-input-error :messages="$errors->get('password')" class="mt-2 text-danger" />
										</div>
										<div class="row d-flex justify-content-between mt-4 mb-2">
											<div class="mb-3">
											   <div class="form-check custom-checkbox ms-1">
													<input id="remember_me" type="checkbox" name="remember" class="form-check-input" id="basic_checkbox_1">
													<label class="form-check-label" for="basic_checkbox_1">Remember my preference</label>
												</div>
											</div>
											<div class="mb-3">
                                             <a href="/forgot" class="mr-3">Forgot Password?</a>
                                             <span class="mr-5 text-success fw-italic">New User Sign Up Here:</span>
