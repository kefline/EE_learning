        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a href="/" class="" href="javascript:void(0);" aria-expanded="false">
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/list_levels">List levels</a></li>
                            <li><a href="/levels">Add levels</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/list_departments">List Departments</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/list_programs">List Programs</a></li>
                            <li><a href="/programs">Add Programs</a></li>
                    ...
                    <li><a href="/admin_results" href="javascript:void(0);" aria-expanded="false">
                    ...
                    <li><a  href="/settings "class="has-arrow " href="javascript:void(0);" aria-expanded="false">
...
<div class="col-xl-6 col-lg-12">
    <div class="card border-0 shadow-sm">
        <div class="card-header border-0 pb-0">
            ...
            <p class="text-muted">Total Exams: <span class="text-dark fw-bold" id="exam-count">3</span></p>
        </div>
        <div class="card-body text-center">
            <div class="mt-4">
                <button class="btn btn-primary me-2">View All Exams</button>
                <button class="btn btn-warning me-2">Edit Exams</button>
                <button class="btn btn-danger">Delete Selected Exams</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-grid gap-2">
                ...
                <button class="btn btn-warning">Edit Questions</button>
                <button class="btn btn-danger">Delete Selected Questions</button>
            </div>
            <div class="mt-4 d-grid gap-2">
                <button class="btn btn-info">View Question Types</button>
                <button class="btn btn-secondary">View Question Levels</button>
                <button class="btn btn-success">View Completed Questions</button>
                <button class="btn btn-outline-secondary">View Pending Questions</button>
            </div>
        </div>
    </div>
</div>
...
<div class="col-xl-4 col-lg-6">
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <p><strong>Average Marks:</strong> 75%</p>
            <p><strong>Top Score:</strong> 95%</p>
            <p><strong>Lowest Score:</strong> 55%</p>
            <div class="progress mb-2">
                <div class="progress-bar progress-animated bg-success" style="width: 75%"></div>
            </div>
            <small>Average Progress Towards Target</small>
            <div class="mt-4">
                <button class="btn btn-primary me-2">View Students</button>
        ...
        <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        <strong>English Paper:</strong> Submit final draft 
                        <small class="text-muted">Assigned by: Mr. Smith</small>
                    </div>
                    <div>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        <strong>Math Homework:</strong> Submission required 
                        <small class="text-muted">Assigned by: Ms. Johnson</small>
                    </div>
                    <div>
                        <span class="badge badge-info me-2">Due in 2 days</span>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        <strong>History Exam:</strong> Prepare for final exam 
                        <small class="text-muted">Assigned by: Dr. Lee</small>
                    </div>
                    <div>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        <strong>Geography Project:</strong> Complete the presentation 
                        <small class="text-muted">Assigned by: Ms. Taylor</small>
                    </div>
                    <div>
