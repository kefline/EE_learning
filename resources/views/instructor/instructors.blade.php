        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/user"><i class="bi bi-person-check"></i><span class="nav-text">User Management</span></a>
                    </li>

                    <li><a href="/courses" class="" href="javascript:void(0);" aria-expanded="false">
                            <i class="bi bi-book"></i>

                            <span class="nav-text">Courses</span>
                        </a>
                    </li>
                    <li><a href="instructors" href="javascript:void(0);" aria-expanded="false">
                            <i class="bi bi-people"></i>

                            <span class="nav-text">Instructors</span>
                        </a>
                    </li>
                    <li><a href="/admin_student" href="javascript:void(0);" aria-expanded="false">
                            <i class="bi bi-people"></i>

                            <span class="nav-text">Students</span>
                        </a>
                    </li>
                    <li><a href="/Exams" class=" " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="Exams_form">Exams</a></li>
                                                ...
                                                <td>
                                                    <div class="dropdown ms-auto text-end">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="#">Suspend Instructor</a>
                                                            <a class="dropdown-item" href="#">Delete Instructor</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
