                            ...
                            <div class="card-body">
                                ...
                                <div class="material-card row mb-4">
                                    <div class="col-xl-6 col-xxl-5">
                                        <img src="images/materials/doc-1.jpg" alt="Material Image"
                                ...
                                <div class="material-card row mb-4">
                                    <div class="col-xl-6 col-xxl-5">
                                        <img src="images/materials/doc-2.jpg" alt="Material Image"
                                            class="img-fluid rounded">
                                    </div>
                                    <div class="col-xl-6 col-xxl-7">
                                        <div class="material-content">
                                ...
                                <div class="material-card row mb-4">
                                    <div class="col-xl-6 col-xxl-5">
                                        <img src="images/materials/doc-3.jpg" alt="Material Image"
                                            class="img-fluid rounded">
                                    </div>
                                    <div class="col-xl-6 col-xxl-7">
                                        <div class="material-content">
                            ...
                            <div class="card-body" style="color: white; padding: 20px;">
                                ...
                                <ul class="list-unstyled" style="padding-left: 0;">
                                    <li class="mb-3 d-flex align-items-center" style="margin-bottom: 15px;">
                                        <i class="fas fa-upload me-3 fs-5"
                                            style="font-size: 1.25rem; margin-right: 15px;"></i>
                                    ...
                                    <li class="mb-3 d-flex align-items-center" style="margin-bottom: 15px;">
                                        <i class="fas fa-trash-alt me-3 fs-5"
                                            style="font-size: 1.25rem; margin-right: 15px;"></i>
                                        <a href="#" style="color: white; text-decoration: none; font-weight: bold;"
                                            data-bs-toggle="modal" data-bs-target="#deleteModal">Delete Materials</a>
                                    </li>
                                    <li class="mb-3 d-flex align-items-center" style="margin-bottom: 15px;">
                                        <i class="fas fa-file-download me-3 fs-5"
                                            style="font-size: 1.25rem; margin-right: 15px;"></i>
                                        <a href="#" style="color: white; text-decoration: none; font-weight: bold;"
